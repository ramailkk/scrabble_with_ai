...
import application.datastructures.TrieNode;
...
public class TheAI {
    ...
    public ArrayList<Tile> myRack;
    public ArrayList<Word> legalMoves = new ArrayList<>();
    public ArrayList<Word> legalMoves_Trans = new ArrayList<>();
    public ArrayList<ArrayList<Integer>> hor_positions = new ArrayList<>();
    public ArrayList<ArrayList<Integer>> ver_positions = new ArrayList<>();
    ...
    public void writeToFile() {
        ...
        new File("game_results").mkdirs();

        try (BufferedWriter writer = new BufferedWriter(new FileWriter("game_results/horiMoves.txt"))) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("game_results/vertiMoves.txt"))) {
            // Iterate through the ArrayList and write each element to the file
            for (int i = 0; i < legalMoves_Trans.size(); i++) {
