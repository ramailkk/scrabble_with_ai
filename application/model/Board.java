...
import application.ai.TheAI;
import application.datastructures.MyTrie;
...
public class Board {
    ...
    public ArrayList<int[]> occupiedCells = new ArrayList<>();
    public MyTrie dictionary = new MyTrie("resources/Dictionaries/words.txt");
    public ArrayList<ArrayList<Integer>> player1moves = new ArrayList<>();
    public ArrayList<ArrayList<Integer>> player2moves = new ArrayList<>();
    public int p1Score = 0;
    public int p2Score = 0;
    public int AI_score = 0;
    public ArrayList<Tile> aiRack;
    public TheAI AI;
    ...
    public void writeData() {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("game_results/moves.txt"))) {
