...
public class Panel extends JPanel implements ActionListener {
    ...
    private void tile_rack_ini(){
        ...
        for (int i = 0; i <tile_rack_player_1.length ; i++) {
            ImageIcon icon = new ImageIcon("resources/imgs/" + String.valueOf(tiles_present_player1.get(i).letter).toUpperCase() + ".png");
            Image image = icon.getImage().getScaledInstance(40,40, Image.SCALE_SMOOTH);
            icon = new ImageIcon(image);
            ...
            icon = new ImageIcon("resources/imgs/" + String.valueOf(tiles_present_player2.get(i).letter).toUpperCase() + ".png");
        ...
        if (player == 1) {
            ...
            for (int i = 0; i <tile_rack_player_2.length ; i++) {
                if (i<tiles_present_player2.size()){
                    ImageIcon icon = new ImageIcon("resources/imgs/" + String.valueOf(tiles_present_player2.get(i).letter).toUpperCase() + ".png");
                    Image image = icon.getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
                    icon = new ImageIcon(image);
        ...
        for(int r = 0; r < 15; r++) {
            for(int c = 0; c < 15; c++) {
                ...
                if(ref_board[r][c].isOccupied) {
                    ...
                    ImageIcon icon = new ImageIcon("resources/imgs/" + String.valueOf(ref_board[r][c].tile.letter) +".png");
